...
def main():
    # Hijack 2020-04-01 AS12389 19:28 UTC - 20:28 UTC
    # Hijack 2020-09-29 AS1221 17:50 UTC - 21:00UTC#### [0.00550, 0.00556], [x[10], x[-10]
    # Hijack 2021-04-16 AS55410 13:49 UTC - 15:19 UTC
    # Hijack 2021-05-18 AS48467 09:00 UTC - 14:00 UTC####xxxxx
    # Hijack 2021-10-13 AS212046 08:58 UTC - 09:58 UTC#### [3e-5, 5e-5], [x[10], x[-10]
    # Hijack 2021-10-25 AS212046 09:56 UTC - 10:32 UTC#### [2e-5, 10e-5], [x[20], x[-20]
    # Leak 2020-08-24 AS42910 11:21 UTC - 16:00 UTC
    # Leak 2021-01-06 AS9304 04:21 UTC - 05:14 UTC #### [0.001, 0.002], [x[0], x[-1]]
    # Leak 2021-06-03 AS199599 10:10 UTC - 12:46 UTC ###[0, 8e-4], [x[10], x[-10]]
    # Leak 2021-08-19 AS265038 16:20 UTC - 16:50 UTC #### [1e-7, 1.5e-5], [x[10], x[-10]]
    # Leak 2021-12-24 AS132215 08:22 UTC - 09:11 UTC #### [0, 8e-5], [x[10], x[-10]]
    # Leak 2021-12-24 AS7633 16:45 UTC - 17:24 UTC
    # 2022-08-13 15:59:39+00:00,265962,25
    # leak.2022-08-23T13:33.31251.weird.res
    # leak.2022-08-28T08:35.10990.weird.res
    # leak.2022-08-28T13:36.58175.weird.res
    # 2022-07-28 13:03 & 52634
    '''
    start_time = "2019-06-24T10:30"
    end_time = "2019-06-24T12:30"
    ty = "Leak"
    asn = 396531
    ...
    # benign_conflict_post_analysis()
    # understand_benign_conflict()
    route_leak_post_analysis_v2()
    # bgp_hijack_post_analysis_v2()
    
    # quarantined_asbinding_post_analysis()
    # quarantined_asvalley_post_analysis()
    # bgp_measurements()
    # collect_longlived_valley()
    # collect_longlived_AsPrefix()
    # measure_benign_conflict()
    # historical_data_analysis()
    # characterize_benign_conflict()
    # total_statistics()
    # bgp_attacks_statistics()
    # whitelists_statistics()
    # measure_distance()
    # plot_bgp_simulation()
    # plot_detection_delay()
    # compare_with_BGPmon()
    # process_route_leak_extra()
    # plot_distance()
    # collect_flapping_events()
    # analyze_error()
    # new_historical_data_analysis()
    # plot_occurrence_frequencies()
    # plot_benign_conflicts_numbers()
    # bgp_incidents_roa_validation()
    # add_prefix()
    # compare_against_spamhaus_DROP()
    # length_more_than_24()
    # sort_emails_to_victims()
    # collect_invalid_routes()  # important code!!!
    # collect_invalid_routes_new_measurements()
    # rpki_invalid_routes_analysis()
    # filter_events()
    # plot_events()
    # get_rpki_operators()
    # check_asbinding_whitelist_test()
    # get_asn_types_dict()
    # combine_verified_files()
    # compute_email_statistics()
    # lov_invalid_post_analysis()
